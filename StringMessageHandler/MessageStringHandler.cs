...
namespace MsgStrHandler
{
    class MessageStringHandler
    {
        static void Main(string[] args)
        {
            ...
            handler.PrintMessage(input);
            // 第三种情况测试A  - 两条消息不完整发送
            input = "[length=13]明天放假，祝大家节日快乐！[length=13]明天放假";
            handler.PrintMessage(input);
            input = "，祝大家节日快乐！";
            handler.PrintMessage(input);
            // 第三种情况测试B  - 两条消息不完整发送
            input = "[length=13]明天放假，祝大家";
            handler.PrintMessage(input);
            input = "节日快乐！[length=13]明天放假，祝大家节日快乐！";
            handler.PrintMessage(input);
            // 第四种情况测试  - 元数据不完整
            input = "[leng";
            handler.PrintMessage(input);  // 不会有输出
            input = "th=13]明天放假，祝大家节日快乐！";
            handler.PrintMessage(input);
